# Time-stamp: <2020-06-03 12:07:10 eu>
...
{"N": "antigens", "select": {"vaccine": {"type": "previous"},  "report": true}, "fill": "blue", "outline": "black", "size": 30, "?label": {"format": "{name-abbreviated}"}, "order": "raise"},
{"N": "antigens", "select": {"vaccine": {"type": "current"},   "report": true}, "fill": "red",  "outline": "black", "size": 30, "?label": {"format": "{name-abbreviated}"}, "order": "raise"},
{"N": "antigens", "select": {"vaccine": {"type": "surrogate"}, "report": true}, "fill": "pink", "outline": "black", "size": 30, "?label": {"format": "{name-abbreviated}"}, "order": "raise"},
#+END_SRC
