# Time-stamp: <2020-06-03 15:16:21 eu>
...
#+BEGIN_SRC json
  ...
  # TODO {"most-used": true} -- single antigen/serum which is the most used according to hidb
...
{"N": "antigens", "select": {"vaccine": {"type": "previous"},  "most-used": true, "report": true}, "fill": "blue", "outline": "black", "size": 30, "label": {"format": "{abbreviated_name} {passage}"}, "order": "raise"},
{"N": "antigens", "select": {"vaccine": {"type": "current"},   "most-used": true, "report": true}, "fill": "red",  "outline": "black", "size": 30, "label": {"format": "{abbreviated_name} {passage}"}, "order": "raise"},
{"N": "antigens", "select": {"vaccine": {"type": "surrogate"}, "most-used": true, "report": true}, "fill": "pink", "outline": "black", "size": 30, "label": {"format": "{abbreviated_name} {passage}"}, "order": "raise"},
#+END_SRC
