# Time-stamp: <2020-05-29 08:49:23 eu>
...
#+BEGIN_SRC json
  {"N": "move", "antigens": {<antigen-select>}, "sera": {<serum-select>}, "report": true,  
   ...
   # "flip_over_line": {"from": <point-position>, "to": <point-position>}, 
   # "flip_over_serum_line": 1 -- scale (1 - mirror, 0.1 - close to serum line, 0 - move to serum line)
  }

  # {"N": "move_antigens", "select": {"reference": true}, "?to": <point-position>, "?relative": [1, 1], "flip_over_line": {"from": <point-position>, "to": <point-position>}, "?flip_over_serum_line": 1, "report": true, "?flip_over_serum_line": "scale (1 - mirror, 0.1 - close to serum line, 0 - move to serum line)"},
  # {"N": "move_sera", "select": {"reference": true}, "?to": <point-position>, "?relative": [1, 1], "flip_over_line": {"from": <point-position>, "to": <point-position>}, "?flip_over_serum_line": 1, "report": true, "?flip_over_serum_line": "scale (1 - mirror, 0.1 - close to serum line, 0 - move to serum line)"},
