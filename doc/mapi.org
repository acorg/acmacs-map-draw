# Time-stamp: <2020-06-03 17:44:29 eu>
...
{"N": "time-series",
 ...
 "output": "/path/name-{ts-name}.pdf", -- output pattern (mandatory)
 "report": true
}
#+END_SRC

Reference antigens and everything modified after (e.g. "/vaccines") are shown on all maps.
