# Time-stamp: <2020-05-31 16:33:39 eu>
...
# {"N": "compare-sequences", "groups": [{"select": <Select Antigens>, "name": "group-1"} ...], "html": "filename.html (filename.js is generated as well)", "json": "filename.json", "report": true, "open": true},
