# Time-stamp: <2020-06-03 11:38:16 eu>
...
{"N": "antigens", "select": {"vaccine": {"type": "previous"}, "?most-used": true}, "fill": "blue", "size": 20, "label": {"format": "{name-abbreviated}"}},
{"N": "antigens", "select": {"vaccine": {"type": "current"}, "?most-used": true}, "fill": "red", "size": 20, "label": {"format": "{name-abbreviated}"}},
{"N": "antigens", "select": {"vaccine": {"type": "surrogate"}}, "fill": "pink", "size": 20, "label": {"format": "{name-abbreviated}"}},
#+END_SRC
