# Time-stamp: <2020-09-30 16:07:41 eu>
...
{"N": "time-series",
 ...
 "output": "/path/name-{ts-numeric}.pdf", -- output pattern (mandatory), {ts_numeric} (-> 2017-06) and {ts_text} (-> June 2017) can be used in addition to <substitute-chart-metadata>
 "title": "{ts-text}", -- replaces {"N": "title", "lines" ...}, can be either string or array of strings, {ts_numeric}, {ts_text}, <substitute-chart-metadata> substituted
