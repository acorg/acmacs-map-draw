...
class ModApplicator:
    ...
    def serum_circle(self, serum, antigen=None, mark_serum=None, mark_antigen=None, circle={}, **args):
        if serum != "":
            ...
            radii = [self._chart.serum_circle_radius_empirical(serum_no=serum_index, antigen_no=ag_no, projection_no=self._projection_no) for ag_no in antigen_indices]
            ...
            if circle.get("radius_line"):
                serum_circle.radius_line(color=circle["radius_line"], line_width=circle.get("radius_line_width", 1.0))
