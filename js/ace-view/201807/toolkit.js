...
//     new MovableWindow({title: title || data.name || data.description || data._id, content: `<pre class='json-highlight'>${av_utils.json_syntax_highlight(JSON.stringify(data, undefined, 2))}</pre>`, parent: invoking_node}).classes("a-json-data");
// }
