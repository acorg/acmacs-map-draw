...
PYBIND11_MODULE(acmacs_map_draw_backend, m)
{
    ...
    py::class_<map_elements::LegendPointLabel>(m, "LegendPointLabel")
            .def("add_line", [](map_elements::LegendPointLabel& legend, std::string outline, std::string fill, std::string label) { legend.add_line(outline, fill, label); }, py::arg("outline"), py::arg("fill"), py::arg("label"))
            .def("add_line", [](map_elements::LegendPointLabel& legend, std::string outline, std::string fill, std::string label, double light) { Color f{fill}, o{outline}; f.light(light); o.light(light); legend.add_line(o, f, label); }, py::arg("outline"), py::arg("fill"), py::arg("label"), py::arg("light"))
            .def("label_size", &map_elements::LegendPointLabel::label_size, py::arg("label_size"))
            .def("point_size", &map_elements::LegendPointLabel::point_size, py::arg("point_size"))
            .def("background", [](map_elements::LegendPointLabel& legend, std::string aBackground) { legend.background(aBackground); }, py::arg("background"))
            .def("border_color", [](map_elements::LegendPointLabel& legend, std::string aBorderColor) { legend.border_color(aBorderColor); }, py::arg("border_color"))
            .def("border_width", &map_elements::LegendPointLabel::border_width, py::arg("border_width"))
            ;

    py::class_<map_elements::Title>(m, "Title")
            .def("remove_all_lines", &map_elements::Title::remove_all_lines)
            .def("add_line", [](map_elements::Title& aTitle, std::string aLine) -> map_elements::Title& { return aTitle.add_line(aLine); }, py::arg("text"))
            .def("add_line", [](map_elements::Title& aTitle, const std::vector<std::string>& aLines) -> map_elements::Title& { for (const auto& line: aLines) { aTitle.add_line(line); } return aTitle; }, py::arg("lines"))
            .def("show", py::overload_cast<bool>(&map_elements::Title::show), py::arg("show"))
            .def("offset", py::overload_cast<double, double>(&map_elements::Title::offset), py::arg("x"), py::arg("y"))
            .def("padding", &map_elements::Title::padding, py::arg("padding"))
            .def("text_size", &map_elements::Title::text_size, py::arg("text_size"))
            .def("text_color", [](map_elements::Title& aTitle, std::string aColor) -> map_elements::Title& { return aTitle.text_color(aColor); }, py::arg("color"))
            .def("background", [](map_elements::Title& aTitle, std::string aBackground) -> map_elements::Title& { return aTitle.background(aBackground); }, py::arg("color"))
            .def("border_color", [](map_elements::Title& aTitle, std::string aBorderColor) -> map_elements::Title& { return aTitle.border_color(aBorderColor); }, py::arg("color"))
            .def("border_width", &map_elements::Title::border_width, py::arg("width"))
            .def("weight", &map_elements::Title::weight, py::arg("weight"))
            .def("slant", &map_elements::Title::slant, py::arg("slant"))
            .def("font_family", &map_elements::Title::font_family, py::arg("font_family"))
            ;

    py::class_<map_elements::Label>(m, "Label")
            .def("offset", &map_elements::Label::offset, py::arg("x"), py::arg("y"), py::return_value_policy::reference)
            .def("offset", [](map_elements::Label& aLabel, const std::vector<double>& aOffset) -> map_elements::Label& { return aLabel.offset(aOffset[0], aOffset[1]); }, py::arg("offset"), py::return_value_policy::reference)
            .def("display_name", &map_elements::Label::display_name, py::arg("name"), py::return_value_policy::reference)
            .def("color", [](map_elements::Label& aLabel, std::string aColor) -> map_elements::Label& { return aLabel.color(aColor); }, py::arg("color"), py::return_value_policy::reference)
            .def("size", &map_elements::Label::size, py::arg("size"), py::return_value_policy::reference)
            .def("weight", &map_elements::Label::weight, py::arg("weight"), py::return_value_policy::reference)
            .def("slant", &map_elements::Label::slant, py::arg("slant"), py::return_value_policy::reference)
            .def("font_family", &map_elements::Label::font_family, py::arg("font_family"), py::return_value_policy::reference)
            ;

    py::class_<map_elements::SerumCircle>(m, "SerumCircle")
            .def("fill", [](map_elements::SerumCircle& sc, std::string color) { sc.fill(color); }, py::arg("color") = "pink")
            .def("outline", [](map_elements::SerumCircle& sc, std::string color, double line_width) { sc.outline(color, line_width); }, py::arg("color") = "pink", py::arg("line_width") = 1.0)
            .def("radius_line", [](map_elements::SerumCircle& sc, std::string color, double line_width) { sc.radius_line(color, line_width); }, py::arg("color") = "pink", py::arg("line_width") = 1.0)
            .def("angles", &map_elements::SerumCircle::angles, py::arg("start") = 0.0, py::arg("end") = 0.0)
            .def("radius_line_no_dash", &map_elements::SerumCircle::radius_line_no_dash)
            .def("radius_line_dash1", &map_elements::SerumCircle::radius_line_dash1)
            .def("radius_line_dash2", &map_elements::SerumCircle::radius_line_dash2)
            ;

    py::class_<map_elements::Arrow>(m, "Arrow")
            .def("from_to", [](map_elements::Arrow& aArrow, double x1, double y1, double x2, double y2) { aArrow.from_to({x1, y1}, {x2, y2}); }, py::arg("x1"), py::arg("y1"), py::arg("x2"), py::arg("y2"))
            .def("color", [](map_elements::Arrow& aArrow, std::string line_color, std::string arrow_head_color) { aArrow.color(line_color, arrow_head_color); }, py::arg("line_color"), py::arg("arrow_head_color"))
            .def("arrow_head_filled", &map_elements::Arrow::arrow_head_filled, py::arg("filled"))
            .def("line_width", &map_elements::Arrow::line_width, py::arg("width"))
            .def("arrow_width", &map_elements::Arrow::arrow_width, py::arg("width"))
            ;

    py::class_<map_elements::Point>(m, "Point")
            .def("center", [](map_elements::Point& aPoint, double x, double y) { aPoint.center({x, y}); }, py::arg("x"), py::arg("y"))
            .def("size", [](map_elements::Point& aPoint, double size) { aPoint.size(Pixels{size}); }, py::arg("size"))
            .def("color", [](map_elements::Point& aPoint, std::string fill_color, std::string outline_color) { aPoint.color(fill_color, outline_color); }, py::arg("fill_color"), py::arg("outline_color"))
            .def("outline_width", &map_elements::Point::outline_width, py::arg("outline_width"))
            ;
    ...
    py::class_<ChartDraw>(m, "ChartDraw")
            ...
            .def("calculate_viewport", [](ChartDraw& cd, bool verbose) { cd.calculate_viewport(verbose); }, py::arg("verbose") = true)
            .def("draw", [](const ChartDraw& chart_draw, std::string filename, double size, bool timer) { chart_draw.draw(filename, size, do_report_time(timer)); }, py::arg("filename"), py::arg("size"), py::arg("timer") = false)
            ...
            .def("legend", [](ChartDraw& cd, std::vector<double> aOrigin) -> map_elements::LegendPointLabel& { return cd.legend({aOrigin[0], aOrigin[1]}); }, py::arg("origin"), py::return_value_policy::reference, py::doc("Origin is in pixels. Negative values in orinin mean from right/bottom of the surface"))
            .def("legend", [](ChartDraw& cd) -> map_elements::LegendPointLabel& { return cd.legend(); }, py::return_value_policy::reference)
            .def("remove_legend", &ChartDraw::remove_legend)
            .def("title", [](ChartDraw& cd, std::vector<double> aOrigin) -> map_elements::Title& { return cd.title({aOrigin[0], aOrigin[1]}); }, py::arg("origin"), py::return_value_policy::reference, py::doc("Origin is in pixels. Negative values in orinin mean from right/bottom of the surface"))
            .def("title", [](ChartDraw& cd) -> map_elements::Title& { return cd.title(); }, py::return_value_policy::reference)
            ...
            .def("serum_circle", [](ChartDraw& cd, size_t aSerumNo, double aRadius) -> map_elements::SerumCircle& { return cd.serum_circle(aSerumNo, Scaled(aRadius)); }, py::arg("serum_no"), py::arg("radius"), py::return_value_policy::reference)
            .def("arrow", [](ChartDraw& cd, double x1, double y1, double x2, double y2) -> map_elements::Arrow& { return cd.arrow({x1, y1}, {x2, y2}); }, py::arg("x1"), py::arg("y1"), py::arg("x2"), py::arg("y2"), py::return_value_policy::reference)
            .def("point", [](ChartDraw& cd, double x, double y, double size) -> map_elements::Point& { return cd.point({x, y}, Pixels{size}); }, py::arg("x"), py::arg("y"), py::arg("size"), py::return_value_policy::reference)
            ;
    ...
    py::class_<GeographicMapWithPointsFromHidb, GeographicMapDraw>(m, "GeographicMapWithPointsFromHidb")
            .def(py::init<std::string, double, double, std::string, double>(), py::arg("virus_type"), py::arg("point_size_in_pixels") = 4.0, py::arg("point_density") = 0.8, py::arg("outline_color") = "grey63", py::arg("outline_width") = 0.5)
            .def("add_points_from_hidb_colored_by_continent", &GeographicMapWithPointsFromHidb::add_points_from_hidb_colored_by_continent_old, py::arg("continent_color"), py::arg("color_override"), py::arg("priority") = std::vector<std::string>{}, py::arg("start_date") = std::string{}, py::arg("end_date") = std::string{})
            .def("add_points_from_hidb_colored_by_clade", &GeographicMapWithPointsFromHidb::add_points_from_hidb_colored_by_clade_old, py::arg("clade_color"), py::arg("color_override"), py::arg("priority") = std::vector<std::string>{}, py::arg("start_date") = std::string{}, py::arg("end_date") = std::string{})
            .def("add_points_from_hidb_colored_by_lineage", &GeographicMapWithPointsFromHidb::add_points_from_hidb_colored_by_lineage_old, py::arg("lineage_color"), py::arg("color_override"), py::arg("priority") = std::vector<std::string>{}, py::arg("start_date") = std::string{}, py::arg("end_date") = std::string{})
            .def("add_points_from_hidb_colored_by_lineage_and_deletion_mutants", &GeographicMapWithPointsFromHidb::add_points_from_hidb_colored_by_lineage_and_deletion_mutants_old, py::arg("lineage_color"), py::arg("color_override"), py::arg("priority") = std::vector<std::string>{}, py::arg("start_date") = std::string{}, py::arg("end_date") = std::string{})
            ;
    ...
    py::class_<GeographicTimeSeriesBase>(m, "GeographicTimeSeries")
            ...
            .def("draw_colored_by_continent", [](GeographicTimeSeriesBase& aTS, std::string aPrefix, const std::map<std::string, std::string>& aContinentColor, const std::map<std::string, std::string>& aColorOverride, double aImageWidth) { aTS.draw(aPrefix, ColoringByContinent(aContinentColor), aColorOverride, aImageWidth); }, py::arg("filename_prefix"), py::arg("continent_color"), py::arg("color_override"), py::arg("image_width"))
            .def("draw_colored_by_clade", [](GeographicTimeSeriesBase& aTS, std::string aPrefix, const std::map<std::string, std::string>& aCladeColor, const std::map<std::string, std::string>& aColorOverride, double aImageWidth) { aTS.draw(aPrefix, ColoringByClade(aCladeColor), aColorOverride, aImageWidth); }, py::arg("filename_prefix"), py::arg("clade_color"), py::arg("color_override"), py::arg("image_width"))
            ...
            .def("draw_colored_by_lineage_and_deletion_mutants", [](GeographicTimeSeriesBase& aTS, std::string aPrefix, const std::map<std::string, std::string>& aLineageColor, std::string aDeletionMutantColor, const std::map<std::string, std::string>& aColorOverride, double aImageWidth) { aTS.draw(aPrefix, ColoringByLineageAndDeletionMutants(aLineageColor, aDeletionMutantColor), aColorOverride, aImageWidth); }, py::arg("filename_prefix"), py::arg("lineage_color"), py::arg("deletion_mutant_color"), py::arg("color_override"), py::arg("image_width"))
            ;

    m.def("geographic_time_series_monthly", [](std::string aVirusType, std::string aStart, std::string aEnd, std::vector<std::string>& aPriority, double aPointSize, double aPointDensity, std::string aOutlineColor, double aOutlineWidth) -> GeographicTimeSeriesBase* { return new GeographicTimeSeriesMonthly(aVirusType, aStart, aEnd, aPriority, aPointSize, aPointDensity, aOutlineColor, aOutlineWidth); }, py::arg("virus_type"), py::arg("start_date"), py::arg("end_date"), py::arg("priority") = std::vector<std::string>{}, py::arg("point_size_in_pixels") = 4.0, py::arg("point_density") = 0.8, py::arg("outline_color") = "grey63", py::arg("outline_width") = 0.5);
    m.def("geographic_time_series_yearly", [](std::string aVirusType, std::string aStart, std::string aEnd, std::vector<std::string>& aPriority, double aPointSize, double aPointDensity, std::string aOutlineColor, double aOutlineWidth) -> GeographicTimeSeriesBase* { return new GeographicTimeSeriesYearly(aVirusType, aStart, aEnd, aPriority, aPointSize, aPointDensity, aOutlineColor, aOutlineWidth); }, py::arg("virus_type"), py::arg("start_date"), py::arg("end_date"), py::arg("priority") = std::vector<std::string>{}, py::arg("point_size_in_pixels") = 4.0, py::arg("point_density") = 0.8, py::arg("outline_color") = "grey63", py::arg("outline_width") = 0.5);
    m.def("geographic_time_series_weekly", [](std::string aVirusType, std::string aStart, std::string aEnd, std::vector<std::string>& aPriority, double aPointSize, double aPointDensity, std::string aOutlineColor, double aOutlineWidth) -> GeographicTimeSeriesBase* { return new GeographicTimeSeriesWeekly(aVirusType, aStart, aEnd, aPriority, aPointSize, aPointDensity, aOutlineColor, aOutlineWidth); }, py::arg("virus_type"), py::arg("start_date"), py::arg("end_date"), py::arg("priority") = std::vector<std::string>{}, py::arg("point_size_in_pixels") = 4.0, py::arg("point_density") = 0.8, py::arg("outline_color") = "grey63", py::arg("outline_width") = 0.5);
