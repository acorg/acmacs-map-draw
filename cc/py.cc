...
PYBIND11_MODULE(acmacs_map_draw_backend, m)
{
    ...
    py::class_<GeographicMapWithPointsFromHidb, GeographicMapDraw>(m, "GeographicMapWithPointsFromHidb")
            ...
            .def("add_points_from_hidb_colored_by_continent", &GeographicMapWithPointsFromHidb::add_points_from_hidb_colored_by_continent, py::arg("continent_color"), py::arg("color_override"), py::arg("priority") = std::vector<std::string>{}, py::arg("start_date") = std::string{}, py::arg("end_date") = std::string{})
            .def("add_points_from_hidb_colored_by_clade", &GeographicMapWithPointsFromHidb::add_points_from_hidb_colored_by_clade, py::arg("clade_color"), py::arg("color_override"), py::arg("priority") = std::vector<std::string>{}, py::arg("start_date") = std::string{}, py::arg("end_date") = std::string{})
            .def("add_points_from_hidb_colored_by_lineage", &GeographicMapWithPointsFromHidb::add_points_from_hidb_colored_by_lineage, py::arg("lineage_color"), py::arg("color_override"), py::arg("priority") = std::vector<std::string>{}, py::arg("start_date") = std::string{}, py::arg("end_date") = std::string{})
            .def("add_points_from_hidb_colored_by_lineage_and_deletion_mutants", &GeographicMapWithPointsFromHidb::add_points_from_hidb_colored_by_lineage_and_deletion_mutants, py::arg("lineage_color"), py::arg("color_override"), py::arg("priority") = std::vector<std::string>{}, py::arg("start_date") = std::string{}, py::arg("end_date") = std::string{})
            ;
