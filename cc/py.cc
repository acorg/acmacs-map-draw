...
PYBIND11_MODULE(acmacs_map_draw_backend, m)
{
    ...
    py::class_<ChartDraw>(m, "ChartDraw")
            ...
            .def("modify", static_cast<void (ChartDraw::*)(size_t, const PointStyle&, bool, bool)>(&ChartDraw::modify), py::arg("index"), py::arg("style"), py::arg("raise_") = false, py::arg("lower") = false)
            .def("modify_serum", static_cast<void (ChartDraw::*)(size_t, const PointStyle&, bool, bool)>(&ChartDraw::modify_serum), py::arg("index"), py::arg("style"), py::arg("raise_") = false, py::arg("lower") = false)
            .def("modify", [](ChartDraw& cd, const std::vector<size_t>& indices, const PointStyle& style, bool raise, bool lower) { cd.modify(indices.begin(), indices.end(), style, raise, lower); }, py::arg("indices"), py::arg("style"), py::arg("raise_") = false, py::arg("lower") = false)
            .def("modify_sera", [](ChartDraw& cd, const std::vector<size_t>& indices, const PointStyle& style, bool raise, bool lower) { cd.modify_sera(indices.begin(), indices.end(), style, raise, lower); }, py::arg("indices"), py::arg("style"), py::arg("raise_") = false, py::arg("lower") = false)
