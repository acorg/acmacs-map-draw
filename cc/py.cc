...
PYBIND11_PLUGIN(acmacs_map_draw_backend)
{
    ...
    py::class_<ChartDraw>(m, "ChartDraw")
            ...
            .def("modify", py::overload_cast<size_t, const PointStyle&, bool, bool>(&ChartDraw::modify), py::arg("index"), py::arg("style"), py::arg("raise_") = false, py::arg("lower") = false)
            .def("modify", py::overload_cast<const std::vector<size_t>&, const PointStyle&, bool, bool>(&ChartDraw::modify), py::arg("indices"), py::arg("style"), py::arg("raise_") = false, py::arg("lower") = false)
