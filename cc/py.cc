...
PYBIND11_MODULE(acmacs_map_draw_backend, m)
{
    ...
    m.def("geographic_time_series_monthly", [](std::string aVirusType, std::string aStart, std::string aEnd, double aPointSize, double aPointDensity, std::string aOutlineColor, double aOutlineWidth) -> GeographicTimeSeriesBase* { return new GeographicTimeSeriesMonthly(aVirusType, aStart, aEnd, aPointSize, aPointDensity, aOutlineColor, aOutlineWidth); }, py::arg("virus_type"), py::arg("start_date"), py::arg("end_date"), py::arg("point_size_in_pixels") = 4.0, py::arg("point_density") = 0.8, py::arg("outline_color") = "grey63", py::arg("outline_width") = 0.5);
    m.def("geographic_time_series_yearly", [](std::string aVirusType, std::string aStart, std::string aEnd, double aPointSize, double aPointDensity, std::string aOutlineColor, double aOutlineWidth) -> GeographicTimeSeriesBase* { return new GeographicTimeSeriesYearly(aVirusType, aStart, aEnd, aPointSize, aPointDensity, aOutlineColor, aOutlineWidth); }, py::arg("virus_type"), py::arg("start_date"), py::arg("end_date"), py::arg("point_size_in_pixels") = 4.0, py::arg("point_density") = 0.8, py::arg("outline_color") = "grey63", py::arg("outline_width") = 0.5);
    m.def("geographic_time_series_weekly", [](std::string aVirusType, std::string aStart, std::string aEnd, double aPointSize, double aPointDensity, std::string aOutlineColor, double aOutlineWidth) -> GeographicTimeSeriesBase* { return new GeographicTimeSeriesWeekly(aVirusType, aStart, aEnd, aPointSize, aPointDensity, aOutlineColor, aOutlineWidth); }, py::arg("virus_type"), py::arg("start_date"), py::arg("end_date"), py::arg("point_size_in_pixels") = 4.0, py::arg("point_density") = 0.8, py::arg("outline_color") = "grey63", py::arg("outline_width") = 0.5);
